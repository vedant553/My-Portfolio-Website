...
import defaultAvatarUrl from '../sections/avatar.jpg';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  avatarUrl: avatarUrlProp = defaultAvatarUrl,
  iconUrl = '',
  grainUrl = '',
  behindGradient,
  innerGradient,
  ...
  miniAvatarUrl,
  name = 'Vedant Nandeshwar',
  title = 'Full-Stack Developer',
  handle = 'vedantnandeshwar',
              ...
              <div className="pc-user-info">
                <div className="pc-user-details">
                  <div className="pc-mini-avatar">
                    <img
                      src={miniAvatarUrl || avatarUrlProp}
                      alt={`${name || 'User'} mini avatar`}
                      loading="lazy"
                      onError={e => {
                        const target = e.target as HTMLImageElement;
                        target.style.opacity = '0.5';
                        target.src = avatarUrlProp;
                      }}
                    />
                  </div>
